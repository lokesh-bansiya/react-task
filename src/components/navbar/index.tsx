...
const Navbar: React.FC = () => {
  const [selectedItem, setSelectedItem] = useState<string>("Home"); // Initialize the selected item
    ...
    <nav className="flex items-center justify-between text-gray-800 p-4">
      ...
      <div className="flex items-center space-x-4">
        ...
        <NavItem
          ...
          text="News Feed"
          selected={selectedItem === "News Feed"}
          onClick={() => handleItemClick("News Feed")}
        />
        ...
        <NavItem
          ...
          text="Find Lawyers"
          selected={selectedItem === "Find Lawyers"}
          onClick={() => handleItemClick("Find Lawyers")}
        />
